...
class SeuilModal {
  ...
  init() {
    ...
    // Empêcher la propagation des clics sur le container
    this.container.addEventListener('click', (e) => {
      e.stopPropagation();
    });

    // Écouter le scroll pour l'animation du footer
...
const ExpandableToggle = (() => {
  ...
  const init = () => {
    const buttons = document.querySelectorAll('.expandable .plus');
